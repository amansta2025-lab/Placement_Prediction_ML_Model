...
DATASET_PATH='C:/Users/AMAN/Documents/placement_prediction/dataset/placement_predict_50K_Raw.csv'
OUTPUT_FOLDER='C:/Users/AMAN/Documents/placement_prediction/outputs/EDA_Analysis_outputs'
...
for col in numeric_cols:
   ...
   plt.savefig(os.path.join(OUTPUT_FOLDER, f"{col}_box_plot.png"),dpi=300,bbox_inches='tight')
   plt.close()
...
print("\nStatistical Summary")
print(summary)
summary.to_csv(os.path.join(OUTPUT_FOLDER, "Stastical_Summary.csv"))


numeric_df = df.select_dtype(include=np.number)
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_FOLDER, "MissingValues_Heatmap.png"))
plt.close()
